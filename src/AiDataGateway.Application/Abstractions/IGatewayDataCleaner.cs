...
public sealed record CleanupResult(int AuditLogsDeleted, int ApprovalRecordsDeleted, int MetricSamplesDeleted, int LogFilesDeleted, DateTimeOffset CutoffUtc);
