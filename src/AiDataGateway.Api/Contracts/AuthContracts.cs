...
public sealed record ResetAdminPasswordRequest(string UserName, string ResetPassword, string NewPassword);
public sealed record UpdateAdminRecoveryRequest(string NewResetPassword);
